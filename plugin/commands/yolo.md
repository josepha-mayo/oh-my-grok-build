...
2. For a one-shot CLI command, append `--yolo` to `omgb exec`, `omgb use`, `omgb browser`, `omgb loop`, `omgb team`, `omgb swarm`, `omgb subagent spawn`, `omgb cron`, `omgb schedule add`, `omgb research --model ...`, or `omgb autonomous`.
